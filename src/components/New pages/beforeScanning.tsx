...
export default function BeforeScanning({ onNext, onPrev }: { onNext: () => void, onPrev: () => void }) {
    ...
    const isStartReady = allInstructionsVisible && sdkReady;
                    ...
                    <div className="mx-auto w-full h-full flex flex-col">
                        ...
                        <div className="flex-shrink-0 pt-4">
                            ...
                            >
                                ...
                                <motion.button
                                    whileHover={{ scale: isStartReady ? 1.08 : 1, y: isStartReady ? -3 : 0 }}
                                    whileTap={{ scale: isStartReady ? 0.95 : 1 }}
                                    initial={{ scale: 0.9, opacity: 0.7 }}
                                    animate={{
                                        scale: isStartReady ? 1 : 0.9,
                                        opacity: isStartReady ? 1 : 0.7
                                    }}
                                ...
                                >
                                    {!sdkReady ? '🔄 Initializing...' :
                                     !allInstructionsVisible ? t('beforeScanning.loadingButton') :
                                     t('beforeScanning.startButton')}
                                </motion.button>
                            </motion.div>
                        </div>
                    </div>
