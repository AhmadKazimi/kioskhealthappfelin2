...
export default function KioskLayout({ children }: KioskLayoutProps) {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden relative bg-gradient-to-b from-[#407EFF] to-white">
      ...
      {/* Responsive Header */}
      <header className="bg-transparent flex-shrink-0 py-2 sm:py-3 z-50 md:py-4 lg:py-6 px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
      ...
      <main className="flex-1 relative z-50 flex flex-col items-center justify-center sm:px-10 min-h-0">
        <div className="w-full h-full mx-auto">{children}</div>
      </main>

      {/* Responsive Footer */}
      <footer className="bg-transparent flex-shrink-0 relative z-50 py-2 sm:py-3 md:py-4 lg:py-6 px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 text-center">
